...
export class ProductServiceOld
{
    ...
    constructor()
    {
        ...
        let userObj2=new Product(20,"SonyDSC","Laptop",100,52,"assets/images/2.jpg");
        let userObj3=new Product(30,"xiomi","Mobile",500,150,"assets/images/3.jpg");
        let userObj4=new Product(40,"Samsung","Laptop",600,500,"assets/images/4.jpg");
...
//     setProductBackToCart(u1:any):void{
// this.products.push(u1);
