...
public class TiendaService {
	...
	public Orders getOrderDetailsForUser(String username, String number)
	...
	public void addToWishlistForUser(String username,Product product)
			throws WishlistNotFoundException {
		new DataStore().addToWishlistForUser(username,product);

	}
	
	public void removeFromWishlistForUser(String username,int productId) throws WishlistNotFoundException{
		new DataStore().removeFromWishlistForUser(username, productId);
	}
